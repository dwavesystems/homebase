# -*- coding: utf-8 -*-
#
# tracts documentation build configuration file, created by
...
version = tracts.__version__
# The full version, including alpha/beta/rc tags.
release = tracts.__version__
